...
pub struct McpConfigProfile {
    /// Profile name
    pub name: String,
    /// Profile description
    pub description: String,
    /// Base configuration settings
    pub settings: McpConfig,
...
pub struct ConfigProfileManager {
    profiles: HashMap<String, McpConfigProfile>,
            ...
            McpConfigProfile {
                ...
                tool_config: ToolConfiguration {
                    enabled_categories: vec![
                        ...
                        ToolCategory::JavaScriptAnalysis,
                    ],
        ...
        self.profiles.insert(
            ...
            McpConfigProfile {
                ...
                tool_config: ToolConfiguration {
                    ...
                    tool_configs: HashMap::new(),
                    enablement_rules: vec![EnablementRule {
                        name: "javascript_repository".to_string(),
                        condition: EnablementCondition::HasLanguages {
                            languages: vec!["javascript".to_string(), "typescript".to_string()],
                        },
                        actions: vec![EnablementAction::EnableCategory {
                            category: ToolCategory::JavaScriptAnalysis,
                        }],
                    }],
                },
                monitoring: MonitoringConfig {
