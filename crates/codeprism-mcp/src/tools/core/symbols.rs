        ...
        result["workflow_guidance"] = serde_json::json!({
            ...
            "analysis_context": {
                ...
                "complexity_hint": match node.kind {
                    codeprism_core::NodeKind::Class => "Consider analyzing inheritance relationships and decorator patterns",
                    codeprism_core::NodeKind::Function | codeprism_core::NodeKind::Method => "Consider tracing data flow and analyzing complexity",
                    codeprism_core::NodeKind::Module => "Consider exploring contained symbols and dependencies",
