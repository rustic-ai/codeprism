//! GCore MCP Server Binary
//! 
//! This binary provides a command-line interface for running the GCore MCP server.
...
use gcore_mcp::server::McpServer;
...
async fn main() -> Result<()> {
    ...
    let matches = Command::new("gcore-mcp")
        ...
        .about("GCore Model Context Protocol Server")
        .long_about(
