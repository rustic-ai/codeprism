...
impl ResourceManager {
    ...
    async fn handle_repository_resource(
        ...
        match uri {
            ...
            "prism://metrics/quality_dashboard" => {
                ...
                let quality_json = serde_json::json!({
                    ...
                    "code_structure": {
                        ...
                        "variables": graph_stats.nodes_by_kind.get(&prism_core::NodeKind::Variable).unwrap_or(&0)
                    },
            ...
            uri if uri.starts_with("prism://repository/file/") => {
                // Individual file content
                let file_path = uri.strip_prefix("prism://repository/file/").unwrap();
...
mod tests {
    ...
    fn test_resource_serialization() {
        let resource = Resource {
            uri: "prism://repository/test.py".to_string(),
